...
const Profile = () => {
  ...
  //Step 1: check email availability then send verification code via cognito
  ...
  //Step 2: confirm code then update sql and authContext
        ...
        <div className="settings-group">
          ...
          <div className="settings-row">
            ...
            <div className="account-row-actions">
              <button className="account-reveal-btn" onClick={() => setRevealEmail(prev => !prev)}>
          ...
          <div className="settings-row">
            <div className="settings-row-info">
              ...
              <span className="settings-row-desc">••••••••</span>
            </div>
